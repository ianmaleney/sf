	...
	<article class="o-article" id="post-<?php the_ID(); ?>">
		...
		<section class="entry-header c-article__header c-article__header--review">
			...
			<div class="c-article__info c-article__info--review">
				...
				<h1 class="c-article__info--title c-article__info--title--review">
					<?php the_title(); ?>
				</h1>
				<p class="c-book-review__author"><i>by</i> <?php the_field("book_author"); ?></h2>
				<p class="c-article__info--author">
