<div class="o-content-row o-content-row--basic">
  <div class="c-row-header">The Stinging Fly Podcast</div>
...
if($archivePosts) {
  ...
  <div class="c-homepage-podcast__wrapper">
			...
			<div class="c-podcast-player__elements-wrapper">
				...
				<div class="c-podcast-player__info">
					...
					<div class="c-podcast-player__volume-wrapper">
						<p>Vol:</p>
						<input id="vol-control" class="c-footer-audio__volume js-audio-volume" type="range" min="0" max="100" step="1" oninput="SetVolume(this.value)" onchange="SetVolume(this.value)" />
					</div>
					<a
