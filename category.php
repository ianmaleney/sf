		...
		<?php 
			if ( have_posts() ) {
				...
				if ($firstLoop && $count > 1) : ?>
					<div class="c-archive-module c-archive-module--category-box">
					<h2 class="c-archive-module--category-box__heading"><?php single_cat_title( __( '', 'textdomain' ) ); ?></h2>
					<?php if (category_description()) { ?>
					<div class="c-archive-module--category-box__info">
